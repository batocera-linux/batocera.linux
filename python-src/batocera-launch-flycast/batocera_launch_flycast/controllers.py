...
from batocera_launch_flycast.paths import FLYCAST_MAPPING
...
def generate_controller_config(controller: Controller, type: Literal['dreamcast', 'arcade']) -> None:
...
def generate_keyboard_config() -> None:
