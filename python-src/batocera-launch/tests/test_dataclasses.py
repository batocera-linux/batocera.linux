...
class TestCachedPropertyInheritance:
    def test_subclass_with_cached_property(self) -> None:
        @cached_dataclass
        class Parent:
            x: int
    ...
    def test_subclass_with_own_fields(self) -> None:
        @cached_dataclass
        class Parent:
            x: int
        ...
        obj = Child(x=3, y=7)
        assert obj.doubled == 6
        assert obj.summed == 10

    def test_subclass_cached_properties_cache_independently(self, mocker: MockerFixture) -> None:
        @cached_dataclass
        class Parent:
            x: int
        ...
        doubled_spy = mocker.spy(Child.doubled, 'func')
        tripled_spy = mocker.spy(Child.tripled, 'func')
    ...
    def test_subclass_without_new_cached_properties(self) -> None:
        @cached_dataclass
        class Parent:
            x: int
    ...
    def test_subclass_override_property(self) -> None:
        @cached_dataclass
        class Parent:
            x: int
