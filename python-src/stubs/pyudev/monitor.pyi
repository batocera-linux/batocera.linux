...
class Monitor:
    ...
    @deprecated(
        'Will be removed in 1.0. Use an explicit loop over `poll()` instead, or monitor asynchronously with `MonitorObserver`'
    )
...
class MonitorObserver(Thread):
    ...
    daemon: bool
    def __init__(
        self, monitor: Monitor, callback: Callable[[Device], object] | None = None, *args: object, **kwargs: object
    ) -> None: ...
    def start(self) -> None: ...
    def run(self) -> None: ...
