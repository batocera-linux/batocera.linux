...
class ViceXplus4(Core):
    def set_core_options(self, core_options: LibretroConfig, /) -> None:
        ...
        # Model type
        core_options.set_from_config('vice_plus4_model', 'plus4_model', default='PLUS4 PAL')
        ...
        # External palette
        core_options.set_from_config('vice_plus4_external_palette', default='colodore_ted')
