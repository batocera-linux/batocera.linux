...
class RPCS3(Emulator):
    ...
    def hdd0_dir(self) -> Path:
        return self.saves_dir / 'ps3' / 'rpcs3' / 'dev_hdd0'
    ...
    def _generate_vfs_config(self, is_psn_squashfs: bool, arcade_game_title: str | None, /) -> None:
        rom_dev_hdd0 = self.rom / 'dev_hdd0'
        rom_dev_hdd1 = self.rom / 'dev_hdd1'
        arcade_usb_config = _ARCADE_USB_CONFIG.get(arcade_game_title or '', {})

        dev_hdd0 = f'{rom_dev_hdd0 if is_psn_squashfs else self.hdd0_dir}/'
    ...
    async def configure(self) -> Command:
        ...
        is_psn_squashfs = self.rom.is_dir() and str(self.rom).startswith('/var/run/') and rom_game_dir.is_dir()
        arcade_game_title = (
            sfo.TITLE
            if is_psn_squashfs
        ...
        generate_controllers_config(self.config_dir, self.config, self.controllers, keyboard=bool(arcade_game_title))
        ...
        self._generate_vfs_config(is_psn_squashfs, arcade_game_title)
