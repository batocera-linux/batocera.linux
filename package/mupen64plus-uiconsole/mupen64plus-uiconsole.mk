...
MUPEN64PLUS_UICONSOLE_VERSION = master
...
MUPEN64PLUS_UICONSOLE_DEPENDENCIES = sdl2 alsa-lib rpi-userland mupen64plus-core

MUPEN64PLUS_UI_PARAMS = VC=1 USE_GLES=1
ifeq ($(BR2_ARM_CPU_ARMV6),y)
        MUPEN64PLUS_UI_PARAMS += VFP_HARD=1
	MUPEN64PLUS_UI_HOST_CPU = armv6
endif

ifeq ($(BR2_ARM_CPU_HAS_NEON),y)
        MUPEN64PLUS_UI_PARAMS += NEON=1
	MUPEN64PLUS_UI_HOST_CPU = armv7
endif
...
define MUPEN64PLUS_UICONSOLE_BUILD_CMDS
	...
	-C $(@D)/projects/unix all $(MUPEN64PLUS_UI_PARAMS) OPTFLAGS="$(TARGET_CXXFLAGS)" 
endef
...
define MUPEN64PLUS_UICONSOLE_INSTALL_TARGET_CMDS
	...
	INSTALL_STRIP_FLAG="" \
	-C $(@D)/projects/unix all $(MUPEN64PLUS_UI_PARAMS) OPTFLAGS="$(TARGET_CXXFLAGS)" install
