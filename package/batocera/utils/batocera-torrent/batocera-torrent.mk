...
define BATOCERA_TORRENT_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/utils/batocera-torrent/batocera-torrent.service $(TARGET_DIR)/usr/share/batocera/services/batocera_torrent
endef
