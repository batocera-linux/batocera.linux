...
define HOTKEYGEN_INSTALL_CONFIG_FILES
	...
	$(INSTALL) -m 0755 $(@D)/hotkeygen.service $(TARGET_DIR)/etc/init.d/S30hotkeygen
	$(INSTALL) -m 0644 $(@D)/hotkeygen-dbus.conf $(TARGET_DIR)/etc/dbus-1/system.d/hotkeygen.conf
