...
ifeq ($(BR2_PACKAGE_RECALBOX_TARGET_C2)$(BR2_PACKAGE_RECALBOX_TARGET_S905)$(BR2_PACKAGE_RECALBOX_TARGET_S912)$(BR2_PACKAGE_RECALBOX_TARGET_XU4)$(BR2_PACKAGE_RECALBOX_TARGET_LEGACYXU4)$(BR2_PACKAGE_RECALBOX_TARGET_X86)$(BR2_PACKAGE_RECALBOX_TARGET_X86_64),y)
		# Version.: Commits on Feb 12, 2018
	MUPEN64PLUS_RSPHLE_VERSION = 8a5fb80d28c6cca134763b63a7badf246832bb6c
