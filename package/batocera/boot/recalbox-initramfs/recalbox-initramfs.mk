...
RECALBOX_INITRAMFS_KCONFIG_FILE = "package/batocera/boot/recalbox-initramfs/busybox.config"
...
define RECALBOX_INITRAMFS_INSTALL_TARGET_CMDS
	...
	cp package/batocera/boot/recalbox-initramfs/init $(INITRAMFS_DIR)/init
