...
# contain patches and config fragments for SoC. It's important
# to set UBOOT_MULTIBOARD_SOC_DIR even if there isn't any patches
# currently because otherwise UBOOT_MULTIBOARD_PATCHES_SOC below
# would get same files as UBOOT_MULTIBOARD_PATCHES_COMMON and
# patches would be applied twice causing a failure.
# Also set BL31 / BL32 generated by arm-trusted-firmware for uboot build.
...
UBOOT_MULTIBOARD_SOC_DIR = common-rk3328
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3399),y)
UBOOT_MULTIBOARD_MAKE_OPTS += BL31=$(BINARIES_DIR)/bl31.elf
UBOOT_MULTIBOARD_SOC_DIR = common-rk3399
else
$(error "Please add UBOOT_MULTIBOARD_MAKE_OPTS (if any) and UBOOT_MULTIBOARD_SOC_DIR for current target SoC")
endif
