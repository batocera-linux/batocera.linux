...
HLSDK_XASH3D_DMC_CONF_OPTS += -DGOLDSOURCE_SUPPORT=1
HLSDK_XASH3D_DMC_CONF_OPTS += -DSERVER_LIBRARY_NAME=dmc
HLSDK_XASH3D_DMC_CONF_OPTS += -DGAMEDIR=dmc
HLSDK_XASH3D_DMC_CONF_OPTS += -DCMAKE_POLICY_VERSION_MINIMUM=3.5
...
define HLSDK_XASH3D_DMC_INSTALL_TARGET_CMDS
	$(INSTALL) -m 0755 -t $(TARGET_DIR)/usr/lib/xash3d/hlsdk/dmc/cl_dlls/ \
	    -D $(@D)/cl_dll/*.so
	$(INSTALL) -m 0755 -t $(TARGET_DIR)/usr/lib/xash3d/hlsdk/dmc/dlls/ \
	    -D $(@D)/dlls/*.so
endef
