...
local function boot_acrobat(cassette_handler)
    common_autoboot.type_at_frame(frame_num, "\n", 100)
    common_autoboot.type_at_frame(frame_num, "UT\n", 200)
    common_autoboot.type_at_frame(frame_num, "Z3\n", 300)
    common_autoboot.type_at_frame(frame_num, "R\n", 400)
