...
dolphinTriforceIni     = dolphinTriforceConfig + '/Dolphin.ini'
dolphinTriforceGfxIni  = dolphinTriforceConfig + '/GFX.ini'
dolphinTriforceSYSCONF = dolphinTriforceData + "/Wii/shared2/sys/SYSCONF"
