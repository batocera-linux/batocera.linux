...
def configPadsIni(playersControllers, altControl):
    ...
    if bool(altControl):
        ...
        # added up, down, left, right for hat joystick
        mapping = {
            "button1": "y",
            "button2": "b",
            "button3": "a",
    ...
    #added fallback value for up, right, left and down
    mapping_fallback = {
        "axisX": "left",
        "axisY": "up",
        "right": "right",
...
# handle digital joystick value with POV1, the rest remain the same.
