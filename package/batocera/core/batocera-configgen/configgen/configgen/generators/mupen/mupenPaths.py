...
MUPEN_USER_MAPPING_XML: Final = MUPEN_CONFIG_DIR / 'input.xml'
MUPEN_USER_MAPPING: Final = MUPEN_CONFIG_DIR / 'input.toml'
MUPEN_SYSTEM_MAPPING: Final = DATAINIT_DIR / 'system' / 'configs' / 'mupen64' / 'input.toml'
