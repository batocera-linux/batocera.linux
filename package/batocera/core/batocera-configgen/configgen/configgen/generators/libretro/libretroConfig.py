...
coreToRetroachievements = {'beetle-saturn', 'blastem', 'bluemsx', 'bluemsx', 'bsnes', 'bsnes_hd', 'desmume', 'fbneo', 'fceumm', 'freeintv', 'gambatte', 'genesisplusgx', 'genesisplusgx-wide', 'handy', 'kronos', 'mednafen_lynx', 'mednafen_ngp', 'mednafen_supergrafx', 'mednafen_wswan', 'melonds', 'mesens', 'mgba', 'mupen64plus-next', 'nestopia', 'o2em', 'parallel_n64', 'pce', 'pce_fast', 'pcfx', 'picodrive', 'pokemini', 'potator', 'ppsspp', 'prosystem', 'quasi88', 'snes9x', 'snes9x_next', 'stella', 'stella2014', 'vb', 'vba-m', 'vecx', 'virtualjaguar'}
