...
def configureINI(config_directory, bios_directory, system, rom, controllers, metadata, guns, wheels, playingWithWheel):
    ...
    # Gun crosshairs - one player only, PCSX2 can't distinguish both guns in evdev
    if system.isOptSet('pcsx2_crosshairs') and system.config["pcsx2_crosshairs"] == "1":
        pcsx2INIConfig.set("USB1", "guncon2_cursor_path", "/usr/pcsx2/bin/resources/crosshairs/Blue.png") # and pcsx2INIConfig.set("USB2", "guncon2_cursor_path", "/usr/pcsx2/bin/resources/crosshairs/Red.png")
    else:
        pcsx2INIConfig.set("USB1", "guncon2_cursor_path", "") # and pcsx2INIConfig.set("USB2", "guncon2_cursor_path", "")
