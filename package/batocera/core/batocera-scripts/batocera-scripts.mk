...
define BATOCERA_SCRIPTS_INSTALL_TARGET_CMDS
    ...
    install -m 0755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-scripts/hooks/bluetooth-discovery-hook $(TARGET_DIR)/usr/share/batocera/configgen/scripts/
endef
