...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_ODROIDGOS),y)
	BATOCERA_SPLASH_SCRIPT=S03splash-image
	BATOCERA_SPLASH_MEDIA=rotate-ogs-image
...
ifeq ($(BATOCERA_SPLASH_MEDIA),rotate-ogs-image)
	BATOCERA_SPLASH_POST_INSTALL_TARGET_HOOKS += BATOCERA_SPLASH_INSTALL_ROTATE_OGS_IMAGE
endif
...
define BATOCERA_SPLASH_INSTALL_ROTATE_OGS_IMAGE
	mkdir -p $(TARGET_DIR)/usr/share/batocera/splash
	convert "$(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-splash/logo.png" -resize 854x480 -fill white -pointsize 15 -annotate +40+440 "$(BATOCERA_SPLASH_TGVERSION)" -rotate -90 "${TARGET_DIR}/usr/share/batocera/splash/logo-version.png"
endef
