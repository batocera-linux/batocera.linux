...
define PPSSPP_INSTALL_TARGET_CMDS
    ...
    # Fix PSP font for languages like CJK
    # (font from https://github.com/notofonts/noto-cjk/tree/main/Sans/OTC/)
    cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/emulators/ppsspp/NotoSansCJK-DemiLight.ttc \
