...
PPSSPP_CONF_OPTS = -DUSE_FFMPEG=ON -DUSING_FBDEV=ON -DUSE_WAYLAND_WSI=OFF \
		   ...
		   -DUSING_X11_VULKAN=OFF -DVULKAN=OFF -DARM_NO_VULKAN=ON -DBUILD_SHARED_LIBS=OFF
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_X86),y)
	PPSSPP_CONF_OPTS += -DX86=ON -DVULKAN=ON -DUSING_X11_VULKAN=ON
endif

# x86_64
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_X86_64),y)
	PPSSPP_CONF_OPTS += -DX86_64=ON -DVULKAN=ON -DUSING_X11_VULKAN=ON
endif

# rpi4
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RPI4),y)
	PPSSPP_CONF_OPTS += -DVULKAN=ON -DUSING_X11_VULKAN=OFF -DARM_NO_VULKAN=OFF
endif
