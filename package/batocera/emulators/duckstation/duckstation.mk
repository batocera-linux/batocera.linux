...
DUCKSTATION_DEPENDENCIES = fmt boost ffmpeg libcurl ecm host-stenzek-shaderc webp
...
DUCKSTATION_CONF_OPTS += -DSHADERC_INCLUDE_DIR=$(HOST_DIR)/stenzek-shaderc/include
DUCKSTATION_CONF_OPTS += -DSHADERC_LIBRARY=$(HOST_DIR)/stenzek-shaderc/lib/libshaderc_shared.so
