...
DUCKSTATION_CONF_OPTS += -DBUILD_QT_FRONTEND=OFF -DBUILD_SDL_FRONTEND=OFF -DBUILD_NOGUI_FRONTEND=ON -DUSE_DRMKMS=ON -DUSE_EGL=ON -DUSE_WAYLAND=OFF -DUSE_X11=OFF
