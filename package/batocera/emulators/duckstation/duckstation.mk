...
#
################################################################################
# Version.: Commits on Feb 03, 2021
DUCKSTATION_VERSION = 469010868ed4b602ac066be75034ee3f1203172f
...
DUCKSTATION_CONF_OPTS += -DBUILD_QT_FRONTEND=OFF -DBUILD_SDL_FRONTEND=OFF -DBUILD_NOGUI_FRONTEND=ON -DUSE_DRMKMS=ON -DUSE_EGL=OFF -DUSE_WAYLAND=OFF -DUSE_X11=OFF
