...
MUPEN64PLUS_GLIDEN64_CFLAGS = $(TARGET_CFLAGS)
MUPEN64PLUS_GLIDEN64_CXXFLAGS = $(TARGET_CXXFLAGS) -include cstdint
...
ifeq ($(BR2_PACKAGE_HAS_LIBEGL),y)
	...
	ifneq ($(BR2_PACKAGE_XORG7),y)
		MUPEN64PLUS_GLIDEN64_CFLAGS += -DEGL_NO_X11
		MUPEN64PLUS_GLIDEN64_CXXFLAGS += -DEGL_NO_X11
	endif
endif

MUPEN64PLUS_GLIDEN64_CONF_OPTS += \
	-DCMAKE_C_FLAGS="$(MUPEN64PLUS_GLIDEN64_CFLAGS)" \
	-DCMAKE_CXX_FLAGS="$(MUPEN64PLUS_GLIDEN64_CXXFLAGS)"
