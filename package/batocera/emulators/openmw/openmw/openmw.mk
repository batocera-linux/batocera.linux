...
# https://gitlab.com/grablair/openmw/-/tree/gui-gamepad-controls-1
OPENMW_VERSION = 5e2031b02666a4b0b454dabb887d1f23f04502c4
OPENMW_SOURCE = openmw-$(OPENMW_VERSION).tar.gz
OPENMW_SITE = https://gitlab.com/grablair/openmw/-/archive/$(OPENMW_VERSION)
...
# glebm/bullet3 openmw-slim-2021-05-12 branch
OPENMW_BULLET_VERSION = 02684135490c6325dc21fed2552b604cf4b02b4d

# master on 13 Apr 2021
OPENMW_MYGUI_VERSION = 293b00c1447c479db8ff328b0b19c655691ff3ad

# master on 6 May 2021
OPENMW_OSG_VERSION = 748dca7ee7f02ce1760a3996fd0b48dae75f3ec3

# master on 5 Mar 2021
OPENMW_RECASTNAVIGATION_VERSION = c5cbd53024c8a9d8d097a4371215e3342d2fdc87
...
OPENMW_CONF_OPTS += -Wno-dev \
	...
	-DOPENMW_VERSION_COMMITHASH=$(OPENMW_VERSION) \
	-DBUILD_LAUNCHER=OFF \
	-DBUILD_WIZARD=OFF \
