...
LIBRETRO_PARALLEL_N64_CFLAGS = $(TARGET_CFLAGS) -std=gnu17 \
	-Wno-error=implicit-function-declaration \
	-Wno-error=incompatible-pointer-types \
	-Wno-error=int-conversion
LIBRETRO_PARALLEL_N64_CXXFLAGS = $(TARGET_CXXFLAGS) -include cstdint
...
define LIBRETRO_PARALLEL_N64_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) \
		CFLAGS="$(LIBRETRO_PARALLEL_N64_CFLAGS)" \
		CXXFLAGS="$(LIBRETRO_PARALLEL_N64_CXXFLAGS)" \
...
PARALLEL_N64_PRE_CONFIGURE_HOOKS += PARALLEL_N64_CROSS_FIXUP
