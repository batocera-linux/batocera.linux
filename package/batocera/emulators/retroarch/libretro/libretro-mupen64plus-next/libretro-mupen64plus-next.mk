...
#
################################################################################
# Version: Commits on Jan 05, 2021
LIBRETRO_MUPEN64PLUS_NEXT_VERSION = 8ef9dfeb8957ad08430e67f8ff41d3225f573053
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RPI4),y)
	...
	LIBRETRO_MUPEN64PLUS_NEXT_EXTRA_ARGS = ARCH=aarch64 GLES3=0 GLES=1
...
# We do not provide GLESv3 library it's provided through GLESv2
define LIBRETRO_MUPEN64PLUS_NEXT_FIX_GLESV3
	sed -i "s+lGLESv3+lGLESv2+g" $(@D)/Makefile
endef

LIBRETRO_MUPEN64PLUS_NEXT_PRE_CONFIGURE_HOOKS += LIBRETRO_MUPEN64PLUS_NEXT_FIX_GLESV3
