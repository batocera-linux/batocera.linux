...
LIBRETRO_MAME_VERSION = lrmame0284
...
define LIBRETRO_MAME_BUILD_CMDS
    $(MAKE) -j$(LIBRETRO_MAME_JOBS) -l$(LIBRETRO_MAME_JOBS) -C $(@D)/ \
        $(LIBRETRO_MAME_ARCH) OPENMP=1 REGENIE=1 VERBOSE=1 NOWERROR=1 \
		PYTHON_EXECUTABLE=python3 CONFIG=libretro LIBRETRO_OS="unix" \
		ARCH="" PROJECT="" ARCHOPTS="$(LIBRETRO_MAME_ARCHOPTS)" \
