...
void main()
{
    ...
    _TMP36 = max(_final30, _final60);
    _maximo = max(_TMP36, _final45);
    if (_nc.x) { 
        if (_px.x) { 
            _TMP37 = _TMP8.xyz;
        } else {
    ...
    _TMP58 = pow(_TMP7.x, 2.40000010E+00);
    _TMP59 = pow(_TMP7.y, 2.40000010E+00);
    _TMP60 = pow(_TMP7.z, 2.40000010E+00);
    _E = vec3(_TMP58, _TMP59, _TMP60);
    _TMP58 = pow(_pix1.x, 2.40000010E+00);
    _TMP59 = pow(_pix1.y, 2.40000010E+00);
    _TMP60 = pow(_pix1.z, 2.40000010E+00);
    _TMP45 = vec3(_TMP58, _TMP59, _TMP60);
    _res1 = _E + _blend1*(_TMP45 - _E);
    _TMP58 = pow(_pix2.x, 2.40000010E+00);
    _TMP59 = pow(_pix2.y, 2.40000010E+00);
    _TMP60 = pow(_pix2.z, 2.40000010E+00);
    _TMP46 = vec3(_TMP58, _TMP59, _TMP60);
    _res2 = _E + _blend2*(_TMP46 - _E);
    _a0354 = _E - _res1;
    _df0352 = abs(_a0354);
    _TMP47 = _df0352.x + _df0352.y + _df0352.z;
    _a0358 = _E - _res2;
    _df0356 = abs(_a0358);
    _TMP48 = _df0356.x + _df0356.y + _df0356.z;
    _TMP49 = float((_TMP48 >= _TMP47));
    _res = _res1 + _TMP49*(_res2 - _res1);
    _TMP58 = pow(_res.x, 4.54545438E-01);
    _TMP59 = pow(_res.y, 4.54545438E-01);
    _TMP60 = pow(_res.z, 4.54545438E-01);
    _TMP50 = vec3(_TMP58, _TMP59, _TMP60);
    _TMP61 = min(vec3( 1.00000000E+00, 1.00000000E+00, 1.00000000E+00), _TMP50);
    _TMP371 = max(vec3( 0.00000000E+00, 0.00000000E+00, 0.00000000E+00), _TMP61);
    _ret_0 = vec4(_TMP371.x, _TMP371.y, _TMP371.z, 1.00000000E+00);
    FragColor = _ret_0;
    return;
} 
#endif
