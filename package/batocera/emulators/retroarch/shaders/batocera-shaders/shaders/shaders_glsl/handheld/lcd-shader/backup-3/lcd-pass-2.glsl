...
void main()
{
    vec4 _out_color;
    vec4 _scene_color;
    _out_color = COMPAT_TEXTURE(Texture, TEX0.xy);
    _scene_color = COMPAT_TEXTURE(Pass1Texture, TEX0.xy);
    _out_color.xyz = _out_color.xyz*9.00390625E-01 + _scene_color.xyz*9.96093750E-02;
    if (_out_color.w == 0.00000000E+00) { 
        FragColor = vec4( 0.00000000E+00, 0.00000000E+00, 1.00000001E-01, 0.00000000E+00);
        return;
    } 
