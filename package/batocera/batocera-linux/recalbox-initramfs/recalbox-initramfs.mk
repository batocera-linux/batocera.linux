...
RECALBOX_INITRAMFS_KCONFIG_FILE = "package/batocera/batocera-linux/recalbox-initramfs/busybox.config"
...
ifeq ($(BR2_PACKAGE_UBOOT_ODROID_C2)$(BR2_PACKAGE_UBOOT_ODROID_XU4)$(BR2_PACKAGE_BATOCERA_TARGET_S905)$(BR2_PACKAGE_BATOCERA_TARGET_S912),y)
...
define RECALBOX_INITRAMFS_INSTALL_TARGET_CMDS
	...
	cp package/batocera/batocera-linux/recalbox-initramfs/init $(INITRAMFS_DIR)/init
