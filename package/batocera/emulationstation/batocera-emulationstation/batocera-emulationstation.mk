...
BATOCERA_EMULATIONSTATION_VERSION = 602ec28fa7f73ef770e176bfd75271b80dcfeac7
...
#ifeq ($(BR2_PACKAGE_LIBCEC_EXYNOS_API)$(BR2_PACKAGE_BATOCERA_TARGET_S922X),y)
...
# on rpi 1 2 3 4 and oxu4, the splash with video + es splash is ok
ifeq ($(BR2_PACKAGE_BATOCERA_RPI_ANY)$(BR2_PACKAGE_BATOCERA_TARGET_XU4),y)
