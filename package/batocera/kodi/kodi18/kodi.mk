...
KODI18_CONF_OPTS += -DCORE_PLATFORM_NAME=x11 -DENABLE_OPENGL=ON
KODI18_DEPENDENCIES += libegl libglu libgl xlib_libX11 xlib_libXext \
	xlib_libXrandr libdrm
else
KODI18_C_FLAGS += -DMESA_EGL_NO_X11_HEADERS -DEGL_NO_X11
KODI18_CXX_FLAGS += -DMESA_EGL_NO_X11_HEADERS -DEGL_NO_X11
endif

ifeq ($(BR2_PACKAGE_KODI18_PLATFORM_X11_OPENGL)$(BR2_PACKAGE_KODI18_PLATFORM_GBM_GL)$(BR2_PACKAGE_KODI18_PLATFORM_WAYLAND_GL),)
KODI18_CONF_OPTS += -DENABLE_OPENGL=OFF
endif
...
KODI18_CONF_OPTS += -DENABLE_AML=ON
KODI18_DEPENDENCIES += libamcodec
else
KODI18_CONF_OPTS += -DENABLE_AML=OFF
endif
...
KODI18_DEPENDENCIES += ffmpeg
KODI18_CXX_FLAGS += -lncurses
KODI18_CONF_OPTS += -DENABLE_INTERNAL_FFMPEG=OFF -DFFMPEG_PATH=$(STAGING_DIR)/usr \
	-DENABLE_LDGOLD=ON \
	-DENABLE_DEBUGFISSION=OFF \
	-DENABLE_LIRCCLIENT=ON \
	-DENABLE_PLIST=ON \
	-DFLATBUFFERS_INCLUDE_DIR=$(HOST_DIR)/usr/include/flatbuffers \
...
KODI18_CONF_OPTS += -DENABLE_INTERNAL_FFMPEG=ON -DENABLE_LDGOLD=OFF \
