...
define BATOCERA_WHEEL_CALIBRATOR_INSTALL_TARGET_CMDS
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/batocera-wheel-calibrator/batocera-wheel-calibrator $(TARGET_DIR)/usr/bin/batocera-wheel-calibrator
endef
