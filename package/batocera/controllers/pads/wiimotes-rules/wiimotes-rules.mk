...
define WIIMOTES_RULES_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/wiimotes-rules/virtual-wii-mouse-bar-remap $(TARGET_DIR)/usr/bin/virtual-wii-mouse-bar-remap
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/wiimotes-rules/virtual-wii-mouse-bar-joystick-status $(TARGET_DIR)/usr/bin/virtual-wii-mouse-bar-joystick-status
endef
