...
ifeq ($(BR2_PACKAGE_ROCKNIX_TARGET_RK3588),y)
ROCKNIX_JOYPAD_DEVICE_NAME = RK3588
else ifeq ($(BR2_PACKAGE_ROCKNIX_TARGET_S922X),y)
ROCKNIX_JOYPAD_DEVICE_NAME = S922X
else ifeq ($(BR2_PACKAGE_ROCKNIX_TARGET_H700),y)
ROCKNIX_JOYPAD_DEVICE_NAME = H700
else ifeq ($(BR2_PACKAGE_ROCKNIX_TARGET_RK3399),y)
