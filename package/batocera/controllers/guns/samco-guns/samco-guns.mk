...
define SAMCO_GUNS_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/samco-guns/virtual-samco-gun-status $(TARGET_DIR)/usr/bin/virtual-samco-gun-status
endef
