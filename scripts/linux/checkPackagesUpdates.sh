...
### CONFIGURATION ###
KODI_LANGUAGES="de_de el_gr es_es eu_es fr_fr it_it pt_br sv_se tr_tr zh_cn"
...
PACKAGES_GROUPS="RETROARCH LIBRETRO MUPEN OPENBOR EMULATORS PORTS WINE CONTROLLERS"
### ############# ###
