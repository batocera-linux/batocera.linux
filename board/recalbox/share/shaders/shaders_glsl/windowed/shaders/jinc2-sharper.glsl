...
void main()
{
    ...
    _x0106 = _x0094*2.82743335E+00;
    _TMP47 = sin(_x0106.x);
    _TMP48 = sin(_x0106.y);
    _TMP49 = sin(_x0106.z);
    _TMP50 = sin(_x0106.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0094 = vec4(_x0094.x == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).x, _x0094.y == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).y, _x0094.z == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).z, _x0094.w == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).w);
    ...
    _TMP50 = sin(_x0150.w);
    _TMP39 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _x0160 = _x0148*2.82743335E+00;
    _TMP47 = sin(_x0160.x);
    _TMP48 = sin(_x0160.y);
    _TMP49 = sin(_x0160.z);
    _TMP50 = sin(_x0160.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0148 = vec4(_x0148.x == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).x, _x0148.y == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).y, _x0148.z == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).z, _x0148.w == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).w);
    ...
    _TMP50 = sin(_x0204.w);
    _TMP39 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _x0214 = _x0202*2.82743335E+00;
    _TMP47 = sin(_x0214.x);
    _TMP48 = sin(_x0214.y);
    _TMP49 = sin(_x0214.z);
    _TMP50 = sin(_x0214.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0202 = vec4(_x0202.x == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).x, _x0202.y == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).y, _x0202.z == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).z, _x0202.w == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).w);
    ...
    _TMP50 = sin(_x0258.w);
    _TMP39 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _x0268 = _x0256*2.82743335E+00;
    _TMP47 = sin(_x0268.x);
    _TMP48 = sin(_x0268.y);
    _TMP49 = sin(_x0268.z);
    _TMP50 = sin(_x0268.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0256 = vec4(_x0256.x == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).x, _x0256.y == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).y, _x0256.z == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).z, _x0256.w == 0.00000000E+00 ? 3.46423125E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).w);
