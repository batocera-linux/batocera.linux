...
void main()
{
    ...
    _TMP1 = dot(vec4(float(MVPMatrix[0].x), float(MVPMatrix[0].y), float(MVPMatrix[0].z), float(MVPMatrix[0].w)), vec4(float(_v0007.x), float(_v0007.y), float(_v0007.z), float(_v0007.w)));
    _r0007.x = float(_TMP1);
    _TMP1 = dot(vec4(float(MVPMatrix[1].x), float(MVPMatrix[1].y), float(MVPMatrix[1].z), float(MVPMatrix[1].w)), vec4(float(_v0007.x), float(_v0007.y), float(_v0007.z), float(_v0007.w)));
    _r0007.y = float(_TMP1);
    _TMP1 = dot(vec4(float(MVPMatrix[2].x), float(MVPMatrix[2].y), float(MVPMatrix[2].z), float(MVPMatrix[2].w)), vec4(float(_v0007.x), float(_v0007.y), float(_v0007.z), float(_v0007.w)));
    _r0007.z = float(_TMP1);
    _TMP1 = dot(vec4(float(MVPMatrix[3].x), float(MVPMatrix[3].y), float(MVPMatrix[3].z), float(MVPMatrix[3].w)), vec4(float(_v0007.x), float(_v0007.y), float(_v0007.z), float(_v0007.w)));
