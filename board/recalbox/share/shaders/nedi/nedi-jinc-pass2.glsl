...
void main()
{
    ...
    _x0096 = _x0094*1.16238928E+00;
    _TMP47 = sin(_x0096.x);
    _TMP48 = sin(_x0096.y);
    _TMP49 = sin(_x0096.z);
    _TMP50 = sin(_x0096.w);
    _TMP39 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _x0106 = _x0094*2.76460171E+00;
    _TMP47 = sin(_x0106.x);
    _TMP48 = sin(_x0106.y);
    _TMP49 = sin(_x0106.z);
    _TMP50 = sin(_x0106.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0094 = vec4(_x0094.x == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).x, _x0094.y == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).y, _x0094.z == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).z, _x0094.w == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0094*_x0094)).w);
    ...
    _x0150 = _x0148*1.16238928E+00;
    _TMP47 = sin(_x0150.x);
    _TMP48 = sin(_x0150.y);
    _TMP49 = sin(_x0150.z);
    _TMP50 = sin(_x0150.w);
    _TMP39 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _x0160 = _x0148*2.76460171E+00;
    _TMP47 = sin(_x0160.x);
    _TMP48 = sin(_x0160.y);
    _TMP49 = sin(_x0160.z);
    _TMP50 = sin(_x0160.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0148 = vec4(_x0148.x == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).x, _x0148.y == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).y, _x0148.z == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).z, _x0148.w == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0148*_x0148)).w);
    ...
    _x0204 = _x0202*1.16238928E+00;
    _TMP47 = sin(_x0204.x);
    _TMP48 = sin(_x0204.y);
    _TMP49 = sin(_x0204.z);
    _TMP50 = sin(_x0204.w);
    _TMP39 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _x0214 = _x0202*2.76460171E+00;
    _TMP47 = sin(_x0214.x);
    _TMP48 = sin(_x0214.y);
    _TMP49 = sin(_x0214.z);
    _TMP50 = sin(_x0214.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0202 = vec4(_x0202.x == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).x, _x0202.y == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).y, _x0202.z == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).z, _x0202.w == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0202*_x0202)).w);
    ...
    _x0258 = _x0256*1.16238928E+00;
    _TMP47 = sin(_x0258.x);
    _TMP48 = sin(_x0258.y);
    _TMP49 = sin(_x0258.z);
    _TMP50 = sin(_x0258.w);
    _TMP39 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _x0268 = _x0256*2.76460171E+00;
    _TMP47 = sin(_x0268.x);
    _TMP48 = sin(_x0268.y);
    _TMP49 = sin(_x0268.z);
    _TMP50 = sin(_x0268.w);
    _TMP40 = vec4(_TMP47, _TMP48, _TMP49, _TMP50);
    _res0256 = vec4(_x0256.x == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).x, _x0256.y == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).y, _x0256.z == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).z, _x0256.w == 0.00000000E+00 ? 3.21354342E+00 : ((_TMP39*_TMP40)/(_x0256*_x0256)).w);
    ...
    _r0310 = _res0094.x*_TMP17.xyz;
    _r0310 = _r0310 + _res0094.y*_TMP18.xyz;
    _r0310 = _r0310 + _res0094.z*_TMP19.xyz;
    _r0310 = _r0310 + _res0094.w*_TMP20.xyz;
    _r0312 = _res0148.x*_TMP21.xyz;
    _r0312 = _r0312 + _res0148.y*_TMP22.xyz;
    _r0312 = _r0312 + _res0148.z*_TMP23.xyz;
    _r0312 = _r0312 + _res0148.w*_TMP24.xyz;
    _color = _r0310 + _r0312;
    _r0314 = _res0202.x*_TMP25.xyz;
    _r0314 = _r0314 + _res0202.y*_TMP26.xyz;
    _r0314 = _r0314 + _res0202.z*_TMP27.xyz;
    _r0314 = _r0314 + _res0202.w*_TMP28.xyz;
    _color = _color + _r0314;
    _r0316 = _res0256.x*_TMP29.xyz;
    _r0316 = _r0316 + _res0256.y*_TMP30.xyz;
    _r0316 = _r0316 + _res0256.z*_TMP31.xyz;
    _r0316 = _r0316 + _res0256.w*_TMP32.xyz;
    _color = _color + _r0316;
    _r0318.x = dot(_res0094, vec4( 1.00000000E+00, 1.00000000E+00, 1.00000000E+00, 1.00000000E+00));
    _r0318.y = dot(_res0148, vec4( 1.00000000E+00, 1.00000000E+00, 1.00000000E+00, 1.00000000E+00));
    _r0318.z = dot(_res0202, vec4( 1.00000000E+00, 1.00000000E+00, 1.00000000E+00, 1.00000000E+00));
    _r0318.w = dot(_res0256, vec4( 1.00000000E+00, 1.00000000E+00, 1.00000000E+00, 1.00000000E+00));
    _TMP37 = dot(_r0318, vec4( 1.00000000E+00, 1.00000000E+00, 1.00000000E+00, 1.00000000E+00));
