...
void main()
{
    ...
    _TMP187 = abs(_a0190);
    _TMP21 = bvec4(_TMP187.x < 1.00000000E+01, _TMP187.y < 1.00000000E+01, _TMP187.z < 1.00000000E+01, _TMP187.w < 1.00000000E+01);
    _a0196 = _r0126.wxyz - _r0136;
    _TMP193 = abs(_a0196);
    _TMP22 = bvec4(_TMP193.x < 1.00000000E+01, _TMP193.y < 1.00000000E+01, _TMP193.z < 1.00000000E+01, _TMP193.w < 1.00000000E+01);
    _a0202 = _r0126.zwxy - _r0126.yzwx;
    _TMP199 = abs(_a0202);
    _TMP23 = bvec4(_TMP199.x < 1.00000000E+01, _TMP199.y < 1.00000000E+01, _TMP199.z < 1.00000000E+01, _TMP199.w < 1.00000000E+01);
    _a0208 = _r0126.zwxy - _r0136.zwxy;
    _TMP205 = abs(_a0208);
    _TMP24 = bvec4(_TMP205.x < 1.00000000E+01, _TMP205.y < 1.00000000E+01, _TMP205.z < 1.00000000E+01, _TMP205.w < 1.00000000E+01);
    _a0214 = _r0146 - _r0136.wxyz;
    _TMP211 = abs(_a0214);
    _TMP25 = bvec4(_TMP211.x < 1.00000000E+01, _TMP211.y < 1.00000000E+01, _TMP211.z < 1.00000000E+01, _TMP211.w < 1.00000000E+01);
    _a0220 = _r0126.wxyz - _r0176.yzwx;
    _TMP217 = abs(_a0220);
    _TMP26 = bvec4(_TMP217.x < 1.00000000E+01, _TMP217.y < 1.00000000E+01, _TMP217.z < 1.00000000E+01, _TMP217.w < 1.00000000E+01);
    _a0226 = _r0126.wxyz - _r0156;
    _TMP223 = abs(_a0226);
    _TMP27 = bvec4(_TMP223.x < 1.00000000E+01, _TMP223.y < 1.00000000E+01, _TMP223.z < 1.00000000E+01, _TMP223.w < 1.00000000E+01);
    _a0232 = _r0126.zwxy - _r0176;
    _TMP229 = abs(_a0232);
    _TMP28 = bvec4(_TMP229.x < 1.00000000E+01, _TMP229.y < 1.00000000E+01, _TMP229.z < 1.00000000E+01, _TMP229.w < 1.00000000E+01);
    _a0238 = _r0126.zwxy - _r0166;
    _TMP235 = abs(_a0238);
    _TMP29 = bvec4(_TMP235.x < 1.00000000E+01, _TMP235.y < 1.00000000E+01, _TMP235.z < 1.00000000E+01, _TMP235.w < 1.00000000E+01);
    _a0244 = _r0146 - _r0136.zwxy;
    _TMP241 = abs(_a0244);
    _TMP30 = bvec4(_TMP241.x < 1.00000000E+01, _TMP241.y < 1.00000000E+01, _TMP241.z < 1.00000000E+01, _TMP241.w < 1.00000000E+01);
    _a0250 = _r0146 - _r0136;
    _TMP247 = abs(_a0250);
    _TMP31 = bvec4(_TMP247.x < 1.00000000E+01, _TMP247.y < 1.00000000E+01, _TMP247.z < 1.00000000E+01, _TMP247.w < 1.00000000E+01);
    _interp_restriction_lv1 = bvec4(_r0146.x != _r0126.w && _r0146.x != _r0126.z && (!_TMP21.x && !_TMP22.x || !_TMP23.x && !_TMP24.x || _TMP25.x && (!_TMP26.x && !_TMP27.x || !_TMP28.x && !_TMP29.x) || _TMP30.x || _TMP31.x), _r0146.y != _r0126.x && _r0146.y != _r0126.w && (!_TMP21.y && !_TMP22.y || !_TMP23.y && !_TMP24.y || _TMP25.y && (!_TMP26.y && !_TMP27.y || !_TMP28.y && !_TMP29.y) || _TMP30.y || _TMP31.y), _r0146.z != _r0126.y && _r0146.z != _r0126.x && (!_TMP21.z && !_TMP22.z || !_TMP23.z && !_TMP24.z || _TMP25.z && (!_TMP26.z && !_TMP27.z || !_TMP28.z && !_TMP29.z) || _TMP30.z || _TMP31.z), _r0146.w != _r0126.z && _r0146.w != _r0126.y && (!_TMP21.w && !_TMP22.w || !_TMP23.w && !_TMP24.w || _TMP25.w && (!_TMP26.w && !_TMP27.w || !_TMP28.w && !_TMP29.w) || _TMP30.w || _TMP31.w));
    _interp_restriction_lv2_left = bvec4(_r0146.x != _r0136.z && _r0126.y != _r0136.z, _r0146.y != _r0136.w && _r0126.z != _r0136.w, _r0146.z != _r0136.x && _r0126.w != _r0136.x, _r0146.w != _r0136.y && _r0126.x != _r0136.y);
    _interp_restriction_lv2_up = bvec4(_r0146.x != _r0136.x && _r0126.x != _r0136.x, _r0146.y != _r0136.y && _r0126.y != _r0136.y, _r0146.z != _r0136.z && _r0126.z != _r0136.z, _r0146.w != _r0136.w && _r0126.w != _r0136.w);
    _a0256 = _r0136.zwxy - _r0166.wxyz;
    _TMP253 = abs(_a0256);
    _TMP32 = bvec4(_TMP253.x < 2.00000000E+00, _TMP253.y < 2.00000000E+00, _TMP253.z < 2.00000000E+00, _TMP253.w < 2.00000000E+00);
    _a0262 = _r0176.wxyz - _r0166.wxyz;
    _TMP259 = abs(_a0262);
    _TMP33 = bvec4(_TMP259.x < 2.00000000E+00, _TMP259.y < 2.00000000E+00, _TMP259.z < 2.00000000E+00, _TMP259.w < 2.00000000E+00);
    _interp_restriction_lv3_left = bvec4(_TMP32.x && !_TMP33.x, _TMP32.y && !_TMP33.y, _TMP32.z && !_TMP33.z, _TMP32.w && !_TMP33.w);
    _a0268 = _r0136 - _r0156.yzwx;
    _TMP265 = abs(_a0268);
    _TMP34 = bvec4(_TMP265.x < 2.00000000E+00, _TMP265.y < 2.00000000E+00, _TMP265.z < 2.00000000E+00, _TMP265.w < 2.00000000E+00);
    _a0274 = _r0176.zwxy - _r0156.yzwx;
    _TMP271 = abs(_a0274);
    _TMP35 = bvec4(_TMP271.x < 2.00000000E+00, _TMP271.y < 2.00000000E+00, _TMP271.z < 2.00000000E+00, _TMP271.w < 2.00000000E+00);
    ...
    _TMP323 = abs(_a0326);
    _edr_left = bvec4((2.00000000E+00*_TMP319).x <= _TMP323.x && _interp_restriction_lv2_left.x, (2.00000000E+00*_TMP319).y <= _TMP323.y && _interp_restriction_lv2_left.y, (2.00000000E+00*_TMP319).z <= _TMP323.z && _interp_restriction_lv2_left.z, (2.00000000E+00*_TMP319).w <= _TMP323.w && _interp_restriction_lv2_left.w);
    _a0330 = _r0126.wxyz - _r0136.zwxy;
    _TMP327 = abs(_a0330);
    _a0334 = _r0126.zwxy - _r0136;
    _TMP331 = abs(_a0334);
    _edr_up = bvec4(_TMP327.x >= (2.00000000E+00*_TMP331).x && _interp_restriction_lv2_up.x, _TMP327.y >= (2.00000000E+00*_TMP331).y && _interp_restriction_lv2_up.y, _TMP327.z >= (2.00000000E+00*_TMP331).z && _interp_restriction_lv2_up.z, _TMP327.w >= (2.00000000E+00*_TMP331).w && _interp_restriction_lv2_up.w);
    ...
    _a0338 = _r0146 - _r0126.wxyz;
    _TMP335 = abs(_a0338);
    _a0342 = _r0146 - _r0126.zwxy;
    _TMP339 = abs(_a0342);
    ...
    _a0346 = _TMP7.xyz - _TMP44;
    _df0344 = abs(_a0346);
    _TMP60 = _df0344.x + _df0344.y + _df0344.z;
    _a0350 = _TMP7.xyz - _TMP52;
    _df0348 = abs(_a0350);
    _TMP61 = _df0348.x + _df0348.y + _df0348.z;
