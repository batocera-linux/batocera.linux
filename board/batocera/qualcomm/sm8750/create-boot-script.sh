...
CMDLINE="label=BATOCERA rootwait video=efifb:off console=tty0 console=ttyMSM0,115200n8 irqaffinity=0-1 cgroup.memory=nokmem,nosocket nosoftlockup clk_ignore_unused pd_ignore_unused logo.nologo quiet vt.cur_default=1 cgroup_no_v1=all"
