...
void main()
{
    ...
    _color.x = int((_OUT._color1.x*2.24000000E+02));
    _color.y = int((_OUT._color1.y*2.24000000E+02));
    _color.z = int((_OUT._color1.z*2.24000000E+02));
    _ohyes = 0;
    if (0 == _ditdex) { 
    ...
    _reduceme.x = _OUT._color1.x*5.00000000E+00;
    _TMP34 = floor(_reduceme.x);
    _reduceme.x = float(int(_TMP34));
    _reduceme.x = _reduceme.x/5.00000000E+00;
    _reduceme.y = _OUT._color1.y*5.00000000E+00;
    _TMP35 = floor(_reduceme.y);
    _reduceme.y = float(int(_TMP35));
    _reduceme.y = _reduceme.y/5.00000000E+00;
    _reduceme.z = _OUT._color1.z*5.00000000E+00;
    _TMP36 = floor(_reduceme.z);
    _reduceme.z = float(int(_TMP36));
    _reduceme.z = _reduceme.z/5.00000000E+00;
    if (_reduceme.x > 2.24000000E+02) { 
        _reduceme.x = 2.24000000E+02;
    } 
    if (_reduceme.y > 2.24000000E+02) { 
        _reduceme.y = 2.24000000E+02;
    } 
    if (_reduceme.z > 2.24000000E+02) { 
        _reduceme.z = 2.24000000E+02;
    } 
