...
# R36S uboot needs this
cp "${BINARIES_DIR}/rk3326-odroidgo2-linux.dtb"     "${BATOCERA_BINARIES_DIR}/boot/rk3326-odroidgo2-linux.dtb"     || exit 1

cp "${BOARD_DIR}/boot/boot.ini"                     "${BATOCERA_BINARIES_DIR}/boot/"                               || exit 1
cp "${BOARD_DIR}/boot/rk3326-batlexp-linux.dtb"     "${BATOCERA_BINARIES_DIR}/boot/boot/rk3326-batlexp-linux.dtb"  || exit 1
