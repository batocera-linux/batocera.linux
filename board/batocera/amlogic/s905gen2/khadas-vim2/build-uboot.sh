...
# Apply patches
PATCHES="${BR2_EXTERNAL_BATOCERA_PATH}/board/batocera/amlogic/s905gen2/patches/uboot/*.patch"
...
cd amlogic-boot-fip && ./build-fip.sh khadas-vim2 ../u-boot.bin ../../../uboot-vim2/
