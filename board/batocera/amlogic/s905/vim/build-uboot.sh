...
# Apply patches
PATCHES="${BR2_EXTERNAL_BATOCERA_PATH}/board/batocera/amlogic/s905/patches/uboot/*.patch"
...
cp u-boot.bin ../../uboot-vim/u-boot.raw
...
cd amlogic-boot-fip && ./build-fip.sh khadas-vim ../u-boot.bin ../../../uboot-vim/
